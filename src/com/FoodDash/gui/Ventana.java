...
public class Ventana extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        menuBg.setLayout(new java.awt.GridBagLayout());
	...
	private void updateMenu(String restaurant)
	{
		...
		{ //FIX BUG HAMBURGUESERIA
			...
			for (int i = 0; i < images.length; i++)
			{
				...
				descriptionLabel.setPreferredSize(
				...
				amounts[i].setPreferredSize(new Dimension(80, 80));
				
				System.out.println("y = "+y);
				
//				System.out.println("icon in ("+x+", "+y+")");
				constraint.gridx = 0;
				constraint.gridy = y;
				menuBg.add(iconLabel, constraint);
//				System.out.println("description in ("+(x+1)+", "+y+")");
				constraint.gridx = 1;
				constraint.gridy = y;
				menuBg.add(descriptionLabel, constraint);
//				System.out.println("amount in ("+(x+2)+", "+y+")");
				constraint.gridx = 2;
				constraint.gridy = y;
				menuBg.add(amounts[i], constraint);
				System.out.println("");
				y++;
			}
		}
		...
		{
			menuBg.add(new JLabel("Parece que este establecimiento todavia no tiene un menu :("));
		}
	}
